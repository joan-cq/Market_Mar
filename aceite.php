...
if ($stmt === false) {
    ...
    // En un entorno de producción, se registraría el error en lugar de mostrarlo.
...
$stmt->close();
// No cerramos la conexión aquí por si es necesaria en otros includes como el footer.
// $conn->close();
?>
